        ...
        <div class="inner">
          ...
          <div class="row">
              ...
              <div class="card card-info card-outline bg-secondary">
                  ...
                  <div class="card-body">
                    <div id="bar-chart_1" style="height: 300px;"></div>
                  </div>
                  <!-- /.card-body-->
              </div>
              <!-- /.card -->
        ...
        <div class="inner">
          ...
          <div class="row">
              ...
              <div class="card card-info card-outline bg-secondary">
                  ...
                  <div class="card-body">
                    <div id="bar-chart_2" style="height: 300px;"></div>
                  </div>
                  <!-- /.card-body-->
              </div>
              <!-- /.card -->
        ...
        <div class="inner">
          ...
          <div class="row">
              ...
              <div class="card card-info card-outline bg-secondary">
                  ...
                  <div class="card-body">
                    <div id="bar-chart_3" style="height: 300px;"></div>
                  </div>
                  <!-- /.card-body-->
              </div>
              <!-- /.card -->
        ...
        <div class="inner">
          ...
          <div class="row">
              ...
              <div class="card card-info card-outline bg-secondary">
                  ...
                  <div class="card-body">
                    <div id="bar-chart_4" style="height: 300px;"></div>
                  </div>
                  <!-- /.card-body-->
              </div>
              <!-- /.card -->
...
*/
    ...
    if(!!document.getElementById('#line-chart') == true)
    {
      /*
      * LINE CHART
      * ----------
    ...
    */
    ...
    var els = document.querySelectorAll('[id^="bar-chart_"]');
